...
handles.user.s = serial(strcat('COM', get(handles.edit_comPort, 'String')), 'Baudrate', 9600);
fprintf(['CONNECT ON COM', get(handles.edit_comPort, 'String'), '\n']);
...
fprintf(['GRIPPER ',num2str(round(get(hObject, 'Value'))), '\n']);
fprintf(handles.user.s, ['GRIPPER ', num2str(round(get(hObject, 'Value')))]);
...
if handles.user.isConnected
    fprintf(['POSITION ',num2str(handles.user.jointAngles(1)), ' ',num2str(handles.user.jointAngles(2))...
    ,' ',num2str(handles.user.jointAngles(3)), ' ', num2str(handles.user.jointAngles(4)), ' ',...
    num2str(handles.user.jointAngles(5)), '\n']);
    fprintf(handles.user.s, ['POSITION ',num2str(handles.user.jointAngles(1)), ' ',num2str(handles.user.jointAngles(2))...
    ,' ',num2str(handles.user.jointAngles(3)), ' ', num2str(handles.user.jointAngles(4)), ' ',...
    num2str(handles.user.jointAngles(5)), '\n']);
end
